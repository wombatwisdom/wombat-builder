...
func ParseDocViewFromConfigView(cv *service.ConfigView) (*DocView, error) {
...
func ParseDocViewFromMethodView(mv *bloblang.MethodView) (*DocView, error) {
	td := mv.TemplateData()
...
func ParseDocViewFromFunctionView(fv *bloblang.FunctionView) (*DocView, error) {
	td := fv.TemplateData()
